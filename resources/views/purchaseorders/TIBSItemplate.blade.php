...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div class="body-section">
                <div class="row-4">
                    <div class="col-7"  style="text-align: center;">
                        <img src="{{ asset('assets/images/TIBSI.gif') }}" alt="Left Image" class="logo" style="float: left; margin-right: 10px; width: 100px; height: 100px;">
                        ...
                        <h4 >THE INVESTREAM BUSINESS SOLUTIONS,INC.</h4>
            ...
            <div class="body-section">
                <div class="row-4" style="margin-bottom: 40px;">
                    <div class="col-7" style="text-align: center;">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="heading" style="font-size: 14px;"> THE INVESTREAM BUSINESS SOLUTIONS, INC.</p>
                    </div>
                </div> 
            </div>
            <div class="body-section" style="margin-bottom: 10px;">
                ...
                <div class="row">
                    <div class="col-7">
                        <p class="heading" style="font-size: 16px;"> Remarks: Vat Zero-Rated. Please also issue Zero-Rated Invoice. Thank You.</p>
                    </div>
                </div>
            </div>   
            <div class="row">
