...
@section('content')
    ...
    <form method="POST" action="{{ url('/add-supplier') }}" enctype="multipart/form-data" >
        @csrf
                                    ...
                                    <div id="MainContent_divForm" class="row">
                                        <div class="col-12" style="overflow: auto; max-height: 500px;">
                                            ...
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col-3">
                                                    <label  class="text-xs">Supplier Name</label>
                                                    <input name="Supplier" type="text" class="form-control form-control-border form-control-sm text-xs" placeholder="Enter Item Name">
                                                </div>
                                                <div class="col-3">
                                                    <label class="text-xs">Address</label>
                                                        <input name="Address" type="text" class="form-control form-control-border form-control-sm text-xs" placeholder="Enter Model No. / Name">
                                                </div>
                                                <div class="col-3">
                                                    <label class="text-xs">Attention</label>
                                                        <input name="Attention" type="text" class="form-control form-control-border form-control-sm text-xs" placeholder="Enter Model No. / Name">
                                                </div>
                                                <div class="card-footer float-right">
                                                    <span id="MainContent_lblStatus"></span>
                                                    <div class="pull-right">
                                                        <button type="submit" id="saveSupplier" class="btn btn-success btn-sm btn-sm"><i class="fa fa-arrow-alt-circle-right"></i>Submit</button>
                                                            <a id="MainContent_lnkCancel" class="btn btn-danger btn-sm btn-sm" href="{{ url('/supplier') }}"><i class="fa fa-times-circle"></i>Cancel</a>
                                                    </div>
                                                </div>
                                            </div>        
                                        </div>
