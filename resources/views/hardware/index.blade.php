                        ...
                        <div class="card mx-auto">
                            <div class="card-header">
                                <div class="card-title">
                                    <a href="{{ url('/add-hardware') }}" id="addPoBtn"class="btn btn-primary btn-sm float-left cyan-button">
                                        ...
                                        @php $counter = 1; @endphp
                                            @foreach ($hardwares as $hardware)
                                                <tr >
                                                    ...
                                                    <td>{{ $hardware->company }}</td>
                                                    <td>
                                                        <div class="dropdown d-inline">
                                                            <button class="btn btn-primary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton{{ $hardware->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                Actions
                                                            </button>
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $hardware->id }}">
                                                                <!-- Update button -->
                                                                <a  class="dropdown-item" id="updatePoBtn" href="{{ url('/edit-hardware/'.$hardware->id) }}">
                                                                    <i class="fas fa-edit blue-edit-icon"></i> Update
                                                                </a>
                                                              
                                                                <!-- Delete button -->
                                                                <a  class="dropdown-item" id="deletePo" href="{{ url('/delete-hardware/'.$hardware->id) }}">
