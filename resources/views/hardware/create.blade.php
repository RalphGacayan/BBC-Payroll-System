...
@section('content')
    ...
    <form method="POST" action="{{ url('/add-hardware') }}" enctype="multipart/form-data" >
        @csrf
                                        ...
                                        <div class="col-12" style="overflow: auto; max-height: 500px;">
                                            ...
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col-3">
                                                    ...
                                                    <input name="Asset" type="text" class="form-control form-control-border form-control-sm text-xs" placeholder="Enter Item Name">
                                                </div>
                                                <div class="col-3">
                                                ...
                                                <div class="col-3">
                                                    <label class="text-xs">Manufacturer</label>
                                                        <input name="Manufacturer" type="text" class="form-control form-control-border form-control-sm text-xs" placeholder="Enter Model No. / Name">
                                                </div>
                                                <div class="col-3">
                                                ...
                                                <div class="col-3">
                                                   ...
                                                   <div class="col-3">
                                                        <label class="text-xs">Remarks</label>
                                                            <input name="Remarks" type="text" class="form-control form-control-border form-control-sm text-xs">
                                                    </div>
                                                    <div class="col-3">
                                                        <label class="text-xs">Assigned To</label>
                                                            <input name="Assigned" type="text" class="form-control form-control-border form-control-sm text-xs">
                                                    </div>
                                                </div>
                                                <div class="card-footer float-right">
                                                    ...
                                                    <div class="pull-right">
                                                        <button type="submit" id="saveComputer" class="btn btn-success btn-sm btn-sm"><i class="fa fa-arrow-alt-circle-right"></i>Submit</button>
                                                            <a id="MainContent_lnkCancel" class="btn btn-danger btn-sm btn-sm" href="{{ url('/hardware') }}"><i class="fa fa-times-circle"></i>Cancel</a>
                                                    </div>
                                                </div>
                                            </div>        
                                        </div>
